const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HomeView-C32WAZTs.js","./vue-vendor-DysFsQJ-.js","./ArticleCard-CxlHfOw4.js","./ArticlesView-C-fq0ebx.js","./ArticleView-DEh-5uPF.js","./ArticleView-C29hGiyQ.css","./TagsView-DeL1rZoX.js","./TagView-Czgacair.js","./ArchiveView-DqwW7pEE.js","./AboutView-CmRrhI0m.js","./NotFoundView-D_N-UosJ.js"])))=>i.map(i=>d[i]);
import{d as D,r as A,c as v,u as x,o as G,a as h,b as m,e as o,w as O,v as B,f as L,g as _,h as y,t as b,F as I,i as M,T as P,j as w,k as T,l as N,m as $,n as K,p as F,q as H,s as U,x as Q,y as V}from"./vue-vendor-DysFsQJ-.js";(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const J=[{id:1769792702089,title:"[AI智能体] - 评估与监控 初探",description:`在 2025 年的 AI 工业界，我们已经达成了一个共识：构建一个 Agent 可能只需要一个周末，但让它稳定地跑在生产环境里，需要一整套严密的评估与监控体系。
...
`}],j=D("articles",()=>{const p=A(J),l=A(null),s=A(!1),a=A(""),n=A(""),i=v(()=>{const e=new Set;return p.value.forEach(r=>{r.tags.forEach(u=>e.add(u))}),Array.from(e).sort()}),d=v(()=>{let e=p.value;if(n.value&&(e=e.filter(r=>r.tags.includes(n.value))),a.value){const r=a.value.toLowerCase();e=e.filter(u=>u.title.toLowerCase().includes(r)||u.description.toLowerCase().includes(r)||u.content.toLowerCase().includes(r))}return e}),t=v(()=>{const e={};return p.value.forEach(r=>{const u=r.date.split("-")[0];e[u]||(e[u]=[]),e[u].push(r)}),Object.entries(e).sort((r,u)=>u[0]-r[0])});function q(e){s.value=!0;const r=typeof e=="string"?Math.floor(parseFloat(e)):e;return l.value=p.value.find(u=>Math.floor(u.id)===r),s.value=!1,l.value}function g(e){a.value=e}function f(e){n.value=e}function c(){a.value="",n.value=""}return{articles:p,currentArticle:l,loading:s,searchQuery:a,selectedTag:n,allTags:i,filteredArticles:d,articlesByDate:t,getArticleById:q,setSearchQuery:g,setSelectedTag:f,clearFilters:c}}),W={class:"relative"},z={class:"relative"},Y={key:0,class:"absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-100 max-h-80 overflow-y-auto z-50"},X={class:"p-2"},Z={class:"text-xs text-gray-500 px-3 py-2"},nn=["onClick"],tn={class:"font-medium text-dark text-sm"},en={class:"text-xs text-gray-500 mt-1 line-clamp-1"},on={key:0,class:"absolute top-full left-0 right-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-100 p-4 text-center text-gray-500 z-50"},rn={__name:"SearchBar",emits:["close"],setup(p,{emit:l}){const s=l,a=x(),n=j(),i=A(""),d=A(null),t=v(()=>{if(!i.value)return[];const c=i.value.toLowerCase();return n.articles.filter(e=>e.title.toLowerCase().includes(c)||e.description.toLowerCase().includes(c)||e.content.toLowerCase().includes(c)).slice(0,5)});function q(){}function g(){var c;i.value="",(c=d.value)==null||c.focus()}function f(c){a.push(`/article/${c}`),s("close")}return G(()=>{var c;(c=d.value)==null||c.focus()}),(c,e)=>(h(),m("div",W,[o("div",z,[O(o("input",{"onUpdate:modelValue":e[0]||(e[0]=r=>i.value=r),type:"text",placeholder:"搜索文章...",class:"w-full px-4 py-2 bg-transparent border-b-2 border-gray-200 rounded-none focus:outline-none focus:border-primary transition-colors duration-300 text-base",onInput:q,ref_key:"searchInput",ref:d},null,544),[[B,i.value]]),i.value?(h(),m("button",{key:0,onClick:g,class:"absolute right-0 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600"},[...e[1]||(e[1]=[o("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])):L("",!0)]),_(P,{name:"fade"},{default:y(()=>[t.value.length>0&&i.value?(h(),m("div",Y,[o("div",X,[o("div",Z," 找到 "+b(t.value.length)+" 篇文章 ",1),(h(!0),m(I,null,M(t.value,r=>(h(),m("button",{key:r.id,onClick:u=>f(r.id),class:"w-full text-left px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors duration-200"},[o("div",tn,b(r.title),1),o("div",en,b(r.description),1)],8,nn))),128))])])):L("",!0)]),_:1}),_(P,{name:"fade"},{default:y(()=>[i.value&&t.value.length===0?(h(),m("div",on," 没有找到相关文章 ")):L("",!0)]),_:1})]))}},sn=(p,l)=>{const s=p.__vccOpts||p;for(const[a,n]of l)s[a]=n;return s},an={class:"sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100"},ln={class:"container-custom"},gn={class:"flex items-center justify-between h-16"},un={class:"hidden md:flex items-center space-x-8"},pn={class:"flex items-center space-x-4"},dn={class:"relative flex items-center"},cn={key:0,class:"flex items-center ml-2"},hn={key:0,class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},mn={key:1,class:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},_n={key:0,class:"md:hidden py-4 border-t border-gray-100"},qn={class:"flex flex-col space-y-4"},fn={__name:"AppHeader",setup(p){const l=A(!1),s=A(!1),a=[{name:"首页",path:"/"},{name:"文章",path:"/articles"},{name:"标签",path:"/tags"},{name:"归档",path:"/archive"},{name:"关于",path:"/about"}];function n(){l.value=!l.value}function i(){s.value=!s.value}return(d,t)=>{const q=w("router-link");return h(),m("header",an,[o("div",ln,[o("div",gn,[_(q,{to:"/",class:"flex items-center space-x-2"},{default:y(()=>[...t[1]||(t[1]=[o("div",{class:"w-8 h-8 bg-primary rounded-lg flex items-center justify-center"},[o("span",{class:"text-white font-bold text-sm"},"W")],-1),o("span",{class:"font-semibold text-lg text-dark hover:text-primary transition-colors"}," Hernon ",-1)])]),_:1}),o("nav",un,[(h(),m(I,null,M(a,g=>_(q,{key:g.path,to:g.path,class:"text-gray-600 hover:text-primary transition-colors link-underline","active-class":"text-primary"},{default:y(()=>[T(b(g.name),1)]),_:2},1032,["to"])),64))]),o("div",pn,[o("div",dn,[o("button",{onClick:n,class:"p-2 text-gray-600 hover:text-primary transition-colors","aria-label":"搜索"},[...t[2]||(t[2]=[o("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})],-1)])]),_(P,{name:"fade"},{default:y(()=>[l.value?(h(),m("div",cn,[_(rn,{onClose:n}),o("button",{onClick:n,class:"ml-2 p-1 text-gray-400 hover:text-gray-600"},[...t[3]||(t[3]=[o("svg",{class:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24"},[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)])])])):L("",!0)]),_:1})]),o("button",{onClick:i,class:"md:hidden p-2 text-gray-600 hover:text-primary transition-colors","aria-label":"菜单"},[s.value?(h(),m("svg",mn,[...t[5]||(t[5]=[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"},null,-1)])])):(h(),m("svg",hn,[...t[4]||(t[4]=[o("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"},null,-1)])]))])])]),_(P,{name:"slide-down"},{default:y(()=>[s.value?(h(),m("nav",_n,[o("div",qn,[(h(),m(I,null,M(a,g=>_(q,{key:g.path,to:g.path,class:"text-gray-600 hover:text-primary transition-colors py-2","active-class":"text-primary",onClick:t[0]||(t[0]=f=>s.value=!1)},{default:y(()=>[T(b(g.name),1)]),_:2},1032,["to"])),64))])])):L("",!0)]),_:1})])])}}},An=sn(fn,[["__scopeId","data-v-35622cef"]]),yn={class:"bg-white border-t border-gray-100 mt-auto"},Sn={class:"container-custom py-8"},bn={class:"flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0"},Ln={class:"text-sm text-gray-500"},Pn={__name:"AppFooter",setup(p){const l=new Date().getFullYear();return(s,a)=>(h(),m("footer",yn,[o("div",Sn,[o("div",bn,[o("div",Ln," © "+b(N(l))+" Hernon. All rights reserved. ",1),a[0]||(a[0]=$('<div class="flex items-center space-x-6"><a href="https://github.com/wanghenan" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors" aria-label="GitHub"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"></path></svg></a><a href="https://blog.csdn.net/qq_33618717?type=blog" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors" aria-label="CSDN" title="CSDN博客"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.015 7.338c4.734-.622 7.676 2.044 8.503 5.365.471 1.895.272 3.712-.535 4.936-1.016 1.543-2.779 2.674-4.836 2.549-2.711-.165-3.683-2.373-5.303-4.045-1.03-1.063-1.94-1.148-2.378-.105-.628 1.494-1.127 3.131-1.913 4.563-1.336 2.436-4.043 2.765-5.666 1.118-1.437-1.46-1.378-4.478.108-5.893 3.027-2.882 7.688-5.17 12.02-5.888zM11.5 4.5c-1.889 0-3.429 1.43-3.609 3.308-.093.972.218 1.867.82 2.518 1.021 1.105 2.634 1.268 3.601.37.624-.58 1.004-1.427 1.037-2.308.051-1.35-1.003-2.473-2.303-2.884-.477-.15-1.022-.15-1.5-.004H11.5zm-8 2.5c-1.38 0-2.5 1.12-2.5 2.5s1.12 2.5 2.5 2.5 2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5zm4.5 12c1.93 0 3.5-1.57 3.5-3.5V12c0-1.93-1.57-3.5-3.5-3.5S12 10.07 12 12v3.5c0 1.93 1.57 3.5 3.5 3.5z"></path></svg></a><a href="https://www.xiaohongshu.com/user/profile/6471d187000000002a03561e" target="_blank" rel="noopener" class="text-gray-400 hover:text-primary transition-colors" aria-label="小红书" title="小红书"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.987 2.194c-3.05-.09-5.787 1.847-6.833 4.792a6.085 6.085 0 00-1.27 4.147c.14.65.49 1.263.987 1.76a5.7 5.7 0 013.15 3.867c.39 1.244.18 2.608-.56 3.679-.75 1.084-1.91 1.72-3.19 1.72-1.02 0-2.03-.34-2.9-.98-1.15-.85-1.84-2.08-1.92-3.43-.11-1.93.55-3.79 1.8-5.1a9.21 9.21 0 013.84-2.49c2.05-.67 4.22-.33 6.03.93 1.14.79 2.01 1.86 2.52 3.09.12.28.08.6-.1.84-.2.27-.52.4-.84.35-.32-.05-.56-.33-.61-.65a6.83 6.83 0 00-2.3-3.12 7.16 7.16 0 00-3.65-1.43c-.96-.13-1.93.11-2.75.67a4.67 4.67 0 00-1.54 1.83c-.14.35-.54.55-.91.46-.37-.1-.56-.49-.45-.84.34-1.1 1.05-2.05 2.01-2.7.95-.65 2.11-.92 3.21-.77.55.08 1.08.26 1.57.54.2.12.45.14.67.05.22-.08.37-.29.38-.52.02-.56.05-1.12.05-1.68 0-.38-.26-.71-.62-.79-.36-.08-.75.06-.94.38-.44.75-.85 1.52-1.22 2.32-.18.38-.63.58-1.04.47-.41-.1-.64-.52-.53-.93.34-1.26.82-2.44 1.43-3.52A7.28 7.28 0 0012.987 2.194z"></path></svg></a><a href="mailto:976062158@qq.com" class="text-gray-400 hover:text-primary transition-colors" aria-label="Email"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></a></div>',1))]),a[1]||(a[1]=o("div",{class:"mt-4 text-center text-xs text-gray-400"}," Built with Vue.js 3 + Vite + Tailwind CSS ",-1))])]))}},Cn={class:"min-h-screen flex flex-col bg-light"},vn={class:"flex-grow"},In={__name:"App",setup(p){return(l,s)=>{const a=w("router-view");return h(),m("div",Cn,[_(An),o("main",vn,[_(a,null,{default:y(({Component:n})=>[_(P,{name:"fade",mode:"out-in"},{default:y(()=>[(h(),K(F(n)))]),_:2},1024)]),_:1})]),_(Pn)])}}},Mn="modulepreload",kn=function(p,l){return new URL(p,l).href},R={},S=function(l,s,a){let n=Promise.resolve();if(s&&s.length>0){const d=document.getElementsByTagName("link"),t=document.querySelector("meta[property=csp-nonce]"),q=(t==null?void 0:t.nonce)||(t==null?void 0:t.getAttribute("nonce"));n=Promise.allSettled(s.map(g=>{if(g=kn(g,a),g in R)return;R[g]=!0;const f=g.endsWith(".css"),c=f?'[rel="stylesheet"]':"";if(!!a)for(let u=d.length-1;u>=0;u--){const C=d[u];if(C.href===g&&(!f||C.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${g}"]${c}`))return;const r=document.createElement("link");if(r.rel=f?"stylesheet":Mn,f||(r.as="script"),r.crossOrigin="",r.href=g,q&&r.setAttribute("nonce",q),document.head.appendChild(r),f)return new Promise((u,C)=>{r.addEventListener("load",u),r.addEventListener("error",()=>C(new Error(`Unable to preload CSS for ${g}`)))})}))}function i(d){const t=new Event("vite:preloadError",{cancelable:!0});if(t.payload=d,window.dispatchEvent(t),!t.defaultPrevented)throw d}return n.then(d=>{for(const t of d||[])t.status==="rejected"&&i(t.reason);return l().catch(i)})},Tn=[{path:"/",name:"Home",component:()=>S(()=>import("./HomeView-C32WAZTs.js"),__vite__mapDeps([0,1,2]),import.meta.url),meta:{title:"首页"}},{path:"/articles",name:"Articles",component:()=>S(()=>import("./ArticlesView-C-fq0ebx.js"),__vite__mapDeps([3,1,2]),import.meta.url),meta:{title:"文章"}},{path:"/article/:id",name:"Article",component:()=>S(()=>import("./ArticleView-DEh-5uPF.js"),__vite__mapDeps([4,1,5]),import.meta.url),meta:{title:"文章详情"}},{path:"/tags",name:"Tags",component:()=>S(()=>import("./TagsView-DeL1rZoX.js"),__vite__mapDeps([6,1]),import.meta.url),meta:{title:"标签"}},{path:"/tag/:tag",name:"Tag",component:()=>S(()=>import("./TagView-Czgacair.js"),__vite__mapDeps([7,1,2]),import.meta.url),meta:{title:"标签文章"}},{path:"/archive",name:"Archive",component:()=>S(()=>import("./ArchiveView-DqwW7pEE.js"),__vite__mapDeps([8,1]),import.meta.url),meta:{title:"归档"}},{path:"/about",name:"About",component:()=>S(()=>import("./AboutView-CmRrhI0m.js"),__vite__mapDeps([9,1]),import.meta.url),meta:{title:"关于"}},{path:"/:pathMatch(.*)*",name:"NotFound",component:()=>S(()=>import("./NotFoundView-D_N-UosJ.js"),__vite__mapDeps([10,1]),import.meta.url),meta:{title:"404"}}],E=H({history:U(),routes:Tn,scrollBehavior(p,l,s){return s||{top:0}}});E.beforeEach((p,l,s)=>{document.title=`${p.meta.title||"页面"} | Hernoon的博客`,s()});const k=Q(In);k.use(V());k.use(E);k.mount("#app");export{sn as _,j as u};
